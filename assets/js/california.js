$('#la').click(function(){ //changes first image to disneyland on california.html//
    $("#row-1-image").attr("src","./assets/images/disneyland.png");
})
$('#la').click(function(){ //changes text to disneyland text on california.html//
...
$('#la').click(function(){ //changes text to universal studios text on california.html//
...
$('#la').click(function(){ //changes second image to universal studios on california.html//
    $("#row-2-image").attr("src","./assets/images/universal-studios.png");
});

$('#san-diego').click(function(){ //changes first image to san diego zoo on california.html//
    $("#row-1-image").attr("src","./assets/images/san-diego-zoo.jpg");
})
$('#san-diego').click(function(){ //changes text to san diego zoo text on california.html//
...
$('#san-diego').click(function(){ //changes text to gaslamp quarter text on california.html//
...
$('#san-diego').click(function(){ //changes second image to gaslamp quarter on california.html//
    $("#row-2-image").attr("src","./assets/images/gaslamp-quarter.png");
});

$('#san-francisco').click(function(){ //changes first image to golden gate bridge on california.html//
    $("#row-1-image").attr("src","./assets/images/golden-gate.jpg");
})
$('#san-francisco').click(function(){ //changes text to golden gate bridge text on california.html//
...
$('#san-francisco').click(function(){ //changes text to alcatraz text on california.html//
...
$('#san-francisco').click(function(){ //changes second image to alcatraz on california.html//
